...
//	}
	...
	public void update_deliveryState(int order_details_num) {
	...
	public int select_refundPrice(int order_num, int total_price) throws SQLException {
		...
		while(rs.next()) {
			int order_price = rs.getInt("order_price");
			int product_qty = rs.getInt("product_qty");
			total_price = total_price - order_price*product_qty;
		}
	...
	public void update_reqRefund(int order_num) {
	...
	public void ckeckOrder(int order_num) {

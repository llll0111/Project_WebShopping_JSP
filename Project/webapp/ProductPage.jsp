  ...
  <div class="container">
    <div class="row" style="padding-top: 30px;">
      <div align="center"  class="col-xl-6">
        <img src="./img/${name}.jpg" style="width: 400px; height: 500px;" /> <!-- ${name} -->
      </div>
      <div class="col-xl-6">
        ...
        <div class="row" style="padding-top: 10px;">
         <span style="padding: 0px;">
          <font class="price1" id="money">${price}</font> 
        ...
        <div class="row">
      	...
      	<form name="allbasket">
      	  ...
      	  <input type="hidden" id="totalmoney" value="${price}">
      	  <input type="hidden" id="allselect" value="1">
      	  <input type="hidden" id="basketname" value="${name}">
      	</form>
      </div>
    </div>
    <div class="row" style="padding-top: 100px">
 	...
 	<div class="row" style="padding-top: 80px" align="center">
 	  <div><h1>상품설명</h1></div>
      <div><img src="./img/${name}.jpg" style="width: 700px; height: 1000px; padding-top: 50px;"/></div>
 	</div>
 	...
 	<div class="row" style="padding-top: 20px">
      <hr class="centerline"/>
      	<p style="padding-top: 3px; font-size: 20px; text-align: center;">${fn:replace(des,replace1,"<br/>")}</p>
    </div>

...
$(document).ready(function () {
	  $(".basket1").click(function () {
	    ...
	    <%}else{%>
	    $('.basket1').prop('href','Basket.do?id=<%=id%>')
      ...
      <div style="margin-left: 66%; font-size: 16px;" class="row" align="right">
        <div class="row" style="padding-right: 10px;">
          <div class="col-xl-4" style="width: 100px; padding: 0px;">
            <a href="Mypage.do?id=<%=id%>" class="class-n1">
	  	  ...
	  	  <div class="col-xl-4" style="width: 60px; padding: 0px;">
	  	  	<a href="QnA.jsp" class="class-n2">고객센터</a>
	  	  </div>
  ...
  <c:if test="${sessionScope.sid == null}">
    <div class="container-fluid">
      <div style="margin-left: 66%; font-size: 16px;" class="row" align="right"> 
        <div class="row" style="padding-right: 10px;">
          <div class="col-xl-4 " id="head1">
            <a href="UserJoinForm.jsp" class="class-n1"><font>회원가입</font></a>
          </div>
          <div class="col-xl-4" id="head2">
      	    <a href="Login.jsp" class="class-n2">로그인</a>
          </div>
          <div class="col-xl-4" id="head1">
      	    <a href="QnA.jsp" class="class-n3"><font>고객센터</font></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container" style="font-size: 20px;" id="header1"> <!-- 사이트제목 검색 장바구니위치  -->
	...
	<div class="col-xl-6 mx-auto" align="center">
      ...
      <div class="col-xl-3 mx-auto">
        <a href="Basket.jsp" style="height: 100px;" id="title3" class="basket1">
      ...
      <div class="container-fluid" style="font-size: 20px;">
        <div class="col-12" >
          <ul class="navbar-nav" id="css-nav" >
    	    ...
    	    <li class="nav-item" id=css-nav2 >
              <a class="nav-link" id=css-nav3 href="bbs.jsp">공지사항/이벤트</a>
	        </li>
		  </ul>
        </div>
      </div>
